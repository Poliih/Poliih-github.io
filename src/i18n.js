    ...
    resources: {
      en: {
        translation: {
          ...
          infoText: "Graduated Software Engineer with experience in fullstack development, artificial intelligence applied to solar energy, and data analysis. Author of an award-winning thesis graded with top marks, focused on energy consumption forecasting using LSTM networks. Participated in projects involving AI, interactive dashboards, REST APIs, and MySQL databases. Analytical profile with a focus on practical and efficient solutions.",
      ...
      pt: {
        translation: {
          ...
          infoText: "Engenheira de Software formada, com experiência em desenvolvimento fullstack, inteligência artificial aplicada à energia solar e análise de dados. Autora de TCC premiado com nota máxima, focado na previsão de consumo energético usando redes LSTM. Participação em projetos com IA, dashboards interativos, APIs REST e banco de dados MySQL. Perfil analítico, com foco em soluções práticas e eficientes.",
          hardSkills: "Hard Skills",
          read_more: "Ler Mais",
          read_less: "Ler Menos",
