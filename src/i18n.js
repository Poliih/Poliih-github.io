    ...
    resources: {
      en: {
        translation: {
          ...
          infoText: "Graduated Software Engineer, with experience in fullstack development, artificial intelligence applied to solar energy, and data analysis. Author of a top-graded thesis focused on energy consumption forecasting using LSTM neural networks.",
      ...
      pt: {
        translation: {
          ...
          infoText: "Engenheira de Software formada, com experiência em desenvolvimento fullstack, inteligência artificial aplicada à energia solar e análise de dados. Autora de TCC com nota máxima, focado na previsão de consumo energético usando redes LSTM.",
          hardSkills: "Hard Skills",
          read_more: "Ler Mais",
          read_less: "Ler Menos",
